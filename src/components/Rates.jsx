...
export default function Rates({ onBookNow }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      desc: `Montego Bay is the closest airport and the one we recommend — the villa collects you and returns you at no charge. Kingston is the farthest; transfers from there are ${RATES.kingstonTransfer} ${RATES.kingstonTransferUnit}.`,
    },
    {
      id: 'excursion',
